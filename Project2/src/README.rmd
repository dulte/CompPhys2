...
```
Note: When using the **energy_analyzer.py** and **rate_and_N_analyzer.py**, use that *MC_cycles* times *number of process* is on the form *2^n*, for some integer *n>0*. This is because blocking needs a data with such a length.
