...
```
Note: When using the **data_analytics.py**, use that *MC_cycles* times *number of process* is on the form *2^n*, for some integrer *n>0*. This is because blocking needs a data with such a length.
