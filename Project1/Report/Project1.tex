...
We plot the mean and the variance for various steps sizes, as discussed in section \ref{sec:finding_optimal_step_size}. This gives the plot shown in figure \ref{fig:find_dx_noimportance} for the brute force sampling.
	...
	\end{table}
		...
		\end{table}
		We do a similar analysis with importance sampling. This gives table \textbf{TABLES}
		 \begin{table}[ht!]
			\begin{adjustwidth}{-2cm}{}
				\begin{tabular}{cccccc}
					N & Analytic energy, $E_a$ [$\hbar \omega$] & Numeric energy, $E_n$ [$\hbar \omega$] & Exact energy, $E$ [$\hbar \omega$]& CPU time $E_a$ [s] &CPU time $E_n$ [s]\\
		 ...
		 \begin{table}[ht!]
		 	\begin{adjustwidth}{-2cm}{}
		 		\begin{tabular}{cccccc}
		 			...
		 			100&$100$&$49.997\pm 0.001$&$100$&58.17&441.62\\
		 			500&$250$&-&250 &56.83 &-
		 		\end{tabular}
		 	\end{adjustwidth}
	...
	\begin{table}[ht!]
		...
		\begin{tabular}{cccc}
			...
			\hline
			10 & $24.271458\pm 2\cdot 10^{-6}$ & 35.10\\
			50 & $123.859\pm 0.001$ & 4338.12\\
			100 & $253.12 \pm 0.06$ & 31442.4\\
		\end{tabular}
		\caption{Local energy in 3 dimensions for the fully interacting system. We use the parameters used by \cite{Nilsen2005}, i.e. $a=0.0043$, $\omega_z=\beta=2.82843$, $\omega=1$. We use brute force sampling and the optimal $\alpha=0.499296$ found by our gradient descent method. }\label{tab:fully_interacting_system}
	\end{table}
	\section{Discussion}
